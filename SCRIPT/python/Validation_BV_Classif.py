...
if __name__ == "__main__":
    ...
    d["output_file"]="/datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/DATA_LEARN_VAL_CLASSIF_MT/2018/"
    ram=8096
    tuiles=["T31TCJ","T31TDJ","T30TYP","T30TYN"]
    grain=range(0,5)
#    
    for jobs in os.listdir(d["data_file"]+"DATA_LEARN_VAL_CLASSIF_MT/2018/"):
        print (jobs)
        for s in grain:
            print ("=========")
            print (s)
            ...
            for t in tuiles:
                ...
                entre=d["data_file"]+'DATA_LEARN_VAL_CLASSIF_MT/2018/'+str(jobs)+'/dataAppVal/%s_seed_%s_val.sqlite'%(t,str(s))
            ...
            os.system("rm /datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/DATA_LEARN_VAL_CLASSIF_MT/2018/%s/Fusion_all/*seed*val*"%(jobs))
...
#        os.system("rm /datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/DATA_LEARN_VAL_CLASSIF_MT/2017/%s/Fusion_all/others_seed_*"% (jobs))
    ...
    for classif in os.listdir('/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'):
        if "MT" == classif :
            print(classif)
        else:
            print ("=============")
            ...
            print ("=============")
            for seed in os.listdir('/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/'):
                if "ColorIndexed.tif" in seed:
                    ...
                    for BV in os.listdir('/datalocal/vboxshare/THESE/CLASSIFICATION//DONNES_SIG/EMPRISE/EMPISE_RASTER_BV/'):
                        ...
                        ConcatenateImages_CROPS.SetParameterStringList("il",[d["data_file"]+'/RPG/MASK_RPG_2018_Er10.tif'])
                        ...
                        ConcatenateImages_Class.SetParameterStringList("il",['/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+"/final/"+seed])
                        ...
                        BandMath.SetParameterString("out",'/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/Classif_'+BV[10:-4]+"_"+seed[13:14]+".tif")
                        ...
                        ClassificationMapRegularization.SetParameterString("io.in", '/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/Classif_'+BV[10:-4]+"_"+seed[13:14]+".tif")
                        ClassificationMapRegularization.SetParameterString("io.out", '/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/Classif_'+BV[10:-4]+"_"+seed[13:14]+"_regularized.tif")
                        ...
                        ComputeConfusionMatrix.SetParameterString("in", '/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/Classif_'+BV[10:-4]+"_"+seed[13:14]+"_regularized.tif")          
                        ComputeConfusionMatrix.SetParameterString("out", '/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/ConfusionMatrix_regularized_%s_%s.csv'% (BV[10:-4],seed[13:14]))       
                        ...
                        print ("Confusion_matrix processing")
                        ComputeConfusionMatrix = otbApplication.Registry.CreateApplication("ComputeConfusionMatrix")
                        ComputeConfusionMatrix.SetParameterString("in", '/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/Classif_'+BV[10:-4]+"_"+seed[13:14]+".tif")          
                        ComputeConfusionMatrix.SetParameterString("out", '/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/'+classif+'/final/ConfusionMatrix_%s_%s.csv'% (BV[10:-4],seed[13:14]))       
                        ComputeConfusionMatrix.SetParameterString("ref","vector")      
                        ComputeConfusionMatrix.SetParameterString("ref.vector.in", d["output_file"]+classif+'/Fusion_all/%s_seed_%s.shp'% (BV[10:-4],seed[13:14])) #d["output_file"]+classif+'/Fusion_all/merge%s.shp'%(seed[13:14])
                        ComputeConfusionMatrix.UpdateParameters()
                        ComputeConfusionMatrix.SetParameterString("ref.vector.field", "labcroirr")
            ...
            for b in ["ADOUR","TARN",'NESTE'] :
                ...
                pathRes="/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/2018/RUN_MT/"+classif+"/final/"
                all_k = []
                all_oa = []
                all_p = []
                all_r = []
