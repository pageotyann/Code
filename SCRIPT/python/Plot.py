...
for j in range(len(df["sum"]/sum(df["sum"]))):
    plt.text(x = y_pos[j] , y = (df["sum"]/sum(df["sum"]))[j] +0.01, s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/REPARITION_RGP_TCJ.png") 

df=pd.read_csv("/datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/STAT_POLY/STAT_RPG_TYP_SUMMER_2017.csv")
df=df.sort_values(by='category', ascending=True)
df["name"]=names_RPG
df=df.reset_index()
y_pos= np.arange(len(list(df["count"])))
...
for j in range(len(df["sum"]/sum(df["sum"]))):
    plt.text(x = y_pos[j] , y = (df["sum"]/sum(df["sum"]))[j] +0.01, s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/REPARITION_RGP_TYP.png") 

df=pd.read_csv("/datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/STAT_POLY/STAT_RPG_TDJ_SUMMER_2017.csv")
df=df.sort_values(by='category', ascending=True)
df["name"]=names_RPG
df=df.reset_index()
y_pos= np.arange(len(list(df["count"])))
...
for j in range(len(df["sum"]/sum(df["sum"]))):
    plt.text(x = y_pos[j] , y = (df["sum"]/sum(df["sum"]))[j] +0.01, s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/REPARITION_RGP_TDJ.png") 
# =============================================================================
# PLOT_DT
# =============================================================================
#
...
df=pd.read_csv("/datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/STAT_POLY/STAT_DT_TCJ_LabCrirr.csv")
df=df.sort_values(by='category', ascending=True)
names_crop_tcj=["Maize_Irr","Soybean_Irr","Others","Maize_Nirr","Soybean_Nirr","Sorghum","Sunflower","Peas"]
df["name"]=names_crop_tcj
df=df.reset_index()
...
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/REPARITION_DT_TCJ.png") 

df=pd.read_csv("/datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/STAT_POLY/STAT_DT_TDJ_LabCrirr.csv")
df=df.sort_values(by='category', ascending=True)
names_crop_tdj=["Maize_Irr","Soybean_Irr","Others","Maize_Nirr","Soybean_Nirr","Sorghum_Nirr","Sunflower_Nirr"]
df["name"]=names_crop_tcj
df=df.reset_index()
y_pos= np.arange(len(list(df.name)))
plt.figure(figsize=(10,10))
...
for j in range(len(df["sum"])):
    plt.text(x = y_pos[j] -0.3 , y = (df["sum"]/0.01)[j], s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/REPARITION_DT_TDJ.png") 
    
df=pd.read_csv("/datalocal/vboxshare/THESE/CLASSIFICATION/TRAITEMENT/STAT_POLY/STAT_DT_TYP_LabCrirr.csv")
df=df.sort_values(by='category', ascending=True)
names_crop_tdj=["Maize_Irr","Soybean_Irr","Others","Maize_Nirr","Soybean_Nirr","Sorghum_Nirr","Sunflower_Nirr","Peas"]
df["name"]=names_crop_tcj
df=df.reset_index()
y_pos= np.arange(len(list(df.name)))
plt.figure(figsize=(10,10))
...
for j in range(len(df["sum"])):
    plt.text(x = y_pos[j] -0.3 , y = (df["sum"]/0.01)[j], s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/REPARITION_DT_TYP.png") 
...
for j in range(len(df["sum"])):
    plt.text(x = y_pos[j] -0.3 , y = (df["sum"]/0.01)[j], s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/HISTO_REP_DT/REPARITION_RPG_TDJ.png") 
...
for j in range(len(df["sum"])):
    plt.text(x = y_pos[j] -0.3 , y = (df["sum"]/0.01)[j], s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/HISTO_REP_DT/REPARITION_RPG_TYP.png") 
...
for j in range(len(df["sum"])):
    plt.text(x = y_pos[j] -0.3 , y = (df["sum"]/0.01)[j], s = list(label)[j], size = 11)
plt.savefig("/datalocal/vboxshare/THESE/CLASSIFICATION/RESULT/PLOT/HISTO_REP_DT/REPARITION_RPG_TCJ.png") 